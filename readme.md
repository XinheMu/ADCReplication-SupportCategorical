...
To train the cardinality estimator on datasets with categorical attributes, run 
convert_categorical.py
then run the aforementioned programs in order

To test the cardinality estimator on any dataset, run
ADC_Cardest_experimental_ver6.py
...
The overall results for each testing run will be directly printed after each test run
The detailed results for each testing run will be saved to the latest sheet in the file "Statistics_"+dataset_name+".xlsx" (eg. Statistics_census.xlsx)
